...
```bash
$ jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore /platforms/android/app/build/outputs/apk/release/my-release-key.keystore app-release-unsigned.apk alias_name
